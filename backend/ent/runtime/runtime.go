...
func init() {
	...
	// usersubscriptionDescAutoAdvanceWeek is the schema descriptor for auto_advance_week field.
	usersubscriptionDescAutoAdvanceWeek := usersubscriptionFields[4].Descriptor()
	// usersubscription.DefaultAutoAdvanceWeek holds the default value on creation for the auto_advance_week field.
	usersubscription.DefaultAutoAdvanceWeek = usersubscriptionDescAutoAdvanceWeek.Default.(bool)
