export default {
  ...
  userSubscriptions: {
    advanceWeek: {
      ...
      autoShortLabel: "自动重置",
      autoHint: "重置将扣除本周剩余时长",
      autoTitle: "开启自动扣时重置？",
      autoDescription: "周额度用尽后，系统将自动扣除本周剩余时长、清空周用量并开始新的 7 天周期，无需再次确认。",
      autoWarning: "订阅到期和月重置时间将同步提前，已扣时长不可撤销。月用量仅在推进到新月周期时清零。日额度耗尽、推进后月额度仍耗尽或没有下一周期时暂停。若当前周额度已用尽，开启后即可自动执行。",
      autoConfirm: "确认开启",
      autoEnabled: "已开启周额度自动重置",
      autoDisabled: "已关闭周额度自动重置",
      autoFailed: "设置保存失败，请重试",

      "action": "重置周限额",
      "title": "重置周额度并扣减时长",
      "description": "本周剩余额度将作废，周用量归零，从确认时刻开始新的 7 天周期。",
      "deduct": "预计扣除订阅时长",
      "newExpiry": "预计新的到期时间",
      "warning": "月重置时间同步提前相同时长，月用量仅在推进到新月周期时清零；日用量不变。本次操作不可撤销，最终扣减按确认时的本周剩余时间计算。",
      "confirm": "确认扣时并重置",
      "duration": "{days} 天 {hours} 小时 {minutes} 分钟",
      "unavailable": "使用周额度后可操作，且须有下一周期可用",
      "success": "已进入下一周，订阅到期时间已更新",
      "failed": "暂时无法重置，请刷新订阅后重试。需已使用周额度，且订阅还有下一周期。"
},
    title: '我的订阅',
