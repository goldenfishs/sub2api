export default {
  ...
  userSubscriptions: {
    advanceWeek: {
      ...
      autoWarning: "Expiry and the monthly reset move earlier together. Deducted time cannot be recovered. Monthly usage resets only when the advanced clock reaches a new monthly period. Automatic resets pause if daily quota or the resulting monthly quota is exhausted, or no following period remains. Enabling this can trigger an immediate reset.",
      ...
      "warning": "The monthly reset moves earlier by the same duration. Monthly usage resets only when a new monthly period is reached; daily usage is unchanged. This cannot be undone. The exact deduction is the time left in the current week when you confirm.",
